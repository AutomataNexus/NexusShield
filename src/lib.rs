...
//!
//! Protects services from SQL injection, SSRF, command injection, path traversal,
//! and automated attacks through a layered defense architecture:
//!
    ...
    match assessment.action {
        ...
        ThreatAction::Warn => {
            tracing::warn!(
                ...
                "NexusShield: elevated threat score"
            );
            shield.audit.record(
